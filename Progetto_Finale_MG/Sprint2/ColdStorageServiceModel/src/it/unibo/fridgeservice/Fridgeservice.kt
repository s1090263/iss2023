		...
		return { //this:ActionBasciFsm
				...
				state("waitRequest") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t032",targetState="handleRequest",cond=whenRequest("storerequest"))
					transition(edgeName="t033",targetState="handleTicket",cond=whenRequest("sendticket"))
					transition(edgeName="t034",targetState="handleStop",cond=whenDispatch("stoptrolley"))
					transition(edgeName="t035",targetState="handleStop",cond=whenDispatch("resumetrolley"))
				}	 
					...
					action { //it:State
						if( checkMsgContent( Term.createTerm("sendticket(TICKET)"), Term.createTerm("sendticket(TICKET)"), 
								...
								request("takecharge", "takecharge($Ticket)" ,"transporttrolley" )  
								 ...
								 answer("sendticket", "ticketrefused", "ticketrefused(ARG)"   )  
								  CurrentlyStored -= Kg  
								 }
